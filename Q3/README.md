...
> **当前交付（2026-09-26）**：Q3 迭代 2 的最终方法、完整实验报告、质量结论和 20 条专项案例均已整理。数值来自现有 valid_v2/special_v2 结果；附件 4 无标签，不报告专项准确率。声画精确时间定位、人工词时听审和官方 A/V 特征行来源的证据状态仍按报告如实保留。
...
- [Q3 最终方法（当前唯一最终方法入口）](../doc/Q3/Q3_最终方法.md)：公式、算法、输入/输出、真实实例链路和代码对应。
- [完整实验报告](reports/iteration_v2/Q3_实验报告.md)：每类中间汇总、消融、失败分析、20 条专项全表和来源索引。
- [本轮质量审查与最终方法修订](reports/iteration_v2/Q3_最终方法与质量结论.md)：核验状态、反例和证据边界。
- [20条专项案例](outputs_v2/index.html)，机器可读结果见 `outputs_v2/`。
- [统一论文数据图册](../doc/paper_figures/index.html)：Q1/Q2/Q3 共 68 组 PNG/PDF/SVG/CSV；Q3 图号 Q3_01–Q3_19 和 Q3_case_01–Q3_case_20 均已登记。
